        ...
        <div className="container">
          ...
          <div className="offcanvas offcanvas-start" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel"
            ...
            <div className="offcanvas-header px-4">
              {/* <div className="fs-3 border-bottom border-warning text-warning">Deepak Raikwar</div> */}
              {/* <hr /> */}
              <button type="button" className="btn btn-outline-warning bi bi-x-lg" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>

            <div className="offcanvas-body px-lg-0 px-5">
              <ul className="navbar-nav fs-5 ms-auto">
                {NavList.map(list => (
                  <li key={list.id} className="nav-item pb-lg-0 pb-3 px-3">
