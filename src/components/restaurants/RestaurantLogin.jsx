      ...
      ApiService.post('restaurant/login/', { res_login_id, res_login_password })
        ...
        .catch((error) => {
          if (error.response) {
            ...
            else if (error.response.status === 404) throw new Error('Invalid API Endpoint');
                  ...
                  <div className="card-body p-4">
                    ...
                    <form onSubmit={handleLogin}>
                      <input
                        ...
                        name="res_login_id" maxLength={100}
                      ...
                      <input
                        type="password"
                        className="form-control form-control-lg rounded-5 mt-2 mb-4"
                        name="res_login_password" minLength={8}
                        maxLength={128}
                      ...
                      <div className="d-grid mb-3">
                        <button type="submit" className="btn btn-lg btn-dark rounded-4 rounded-5">
                          Login
                        </button>
                      </div>
                      ...
                      <div className="text-center mt-5">
                        <p className="mb-0">
                          ...
                          <Link to="/restaurant-register" className="text-danger text-decoration-none">
                            Register Now
                          </Link>
                        </p>
                      </div>
